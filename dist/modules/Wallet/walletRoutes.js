 ...
 * @access Private
 */
router.get("/card/:cardSerialNumber", verifyToken, WalletController.getWalletByCard);
/**
 ...
 */
router.post("/transfer/gasless", verifyToken, WalletController.executeGaslessTransfer);
