...
export var io = new Server(httpServer, {
    cors: {
...
httpServer.listen(ENVIRONMENT.APP.PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logger.info("".concat(ENVIRONMENT.APP.NAME, " Running on http://localhost:").concat(ENVIRONMENT.APP.PORT));
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                error_1 = _a.sent();
                logger.error("❌ Failed to connect to database:", error_1);
                return [3 /*break*/, 4];
