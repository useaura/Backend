...
function start() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, db_1.connectDB)(MONGO_URI)];
                case 1:
                    _a.sent();
                    app = express();
                    ...
                    // protected routes
                    app.use("/api/wallet", (0, auth_2.authMiddleware)(JWT_SECRET), wallet_1.walletRouter);
                    app.use("/api/settings", (0, auth_2.authMiddleware)(JWT_SECRET), settings_1.settingsRouter);
